                  ...
                  {grouped[stage].map((lead) => {
                    ...
                    return (
                      <article
                        ...
                        className="cursor-pointer rounded-2xl border border-zinc-200 bg-white p-4 transition hover:bg-zinc-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-900/20 focus-visible:ring-offset-2"
                      >
                        ...
                        <div className="mt-3 space-y-1 text-xs">
                          ...
                          <p className={overdue ? 'text-red-700' : 'text-zinc-500'}>
                            {t('pipeline.card.nextAt')}: <span className={overdue ? 'text-red-700' : 'text-zinc-700'}>{new Date(lead.next_action_at).toLocaleString()}</span>
                          </p>
                        </div>
                        ...
                        <div className="mt-4 flex flex-wrap gap-2">
                          <button
                            ...
                            disabled={isBusy}
                            className="rounded-xl border border-zinc-200 bg-white px-3 py-2 text-xs text-zinc-700 transition hover:bg-zinc-50 disabled:opacity-50"
                          >
                            {t('drawer.logTouch')}
                          </button>
                          ...
                          {(['contacted', 'replied', 'proposal'] as LeadStage[]).map((target) => (
                            <button
                              ...
                              className="rounded-xl border border-zinc-200 bg-white px-3 py-2 text-xs text-zinc-700 transition hover:bg-zinc-50 disabled:opacity-40"
                            >
