...
describe('AI research card', () => {
  it('shows pending and completed states without message or approval mutations', async () => {
    ...
    resolve({ ok: true, job_id: 'research-123', research_snapshot_id: 'snapshot', research_version: 3, status: 'completed', provider: 'openai', model: 'test-model', schema_version: 'research_v1', usage: { input_tokens: 1, cached_input_tokens: 0, output_tokens: 1, total_tokens: 2 }, cost: { estimated_usd: null, status: 'not_configured' }, duration_ms: 9, source_count: 1 })
