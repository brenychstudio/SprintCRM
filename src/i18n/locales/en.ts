const en: Record<string, string> = {
  ...
  'pipeline.card.nextAt': 'Next action at',
  'pipeline.card.overdue': 'Overdue',
  'pipeline.action.move': 'Move',
  'pipeline.action.open': 'Open',
  'pipeline.empty': 'No active leads in pipeline.',
  ...
  'reports.funnel.proposal': 'Proposal sent',
