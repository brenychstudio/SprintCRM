...
export type AiDraftGenerationErrorCode = 'invalid_request' | 'unauthorized' | 'unavailable' | 'runtime_disabled' | 'draft_disabled' | 'research_required' | 'stale_research' | 'invalid_member_state' | 'configuration_missing' | 'provider_rate_limited' | 'provider_timeout' | 'provider_error' | 'invalid_provider_response' | 'persistence_error' | 'request_failed'
