...
-- OUTREACH-03C-QUALITY-05: accept the V3 required verified-proof contract
-- for new jobs while preserving V1 and V2 as valid immutable history. All
...
begin
  ...
  if p_campaign_member_id is null or p_actor_user_id is null or p_confirmed_research_snapshot_id is null or p_request_id is null or nullif(btrim(p_model), '') is null or p_prompt_version not in ('outreach_draft_v1', 'outreach_draft_v2', 'outreach_draft_v3') then
